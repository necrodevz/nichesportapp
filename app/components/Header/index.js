...
class Header extends React.Component { // eslint-disable-line react/prefer-stateless-function
  ...
  render() {
    return (
      <MuiThemeProvider>
        <AppBar title={<img src={LogoImg} style={{"height":"50px","width":"50px"}}/>} style={{"height":"70px"}} showMenuIconButton={false} onRightIconButtonTouchTap={()=>this.logout()} onTitleTouchTap={()=>window.location.assign("/") }>
